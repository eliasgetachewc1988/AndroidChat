...
import com.example.king.chat.bean.User;
...
public class splashScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean isLogin = Utils.getBooleanValue(splashScreen.this,
                SyncStateContract.Constants.LoginState);
        if (isLogin) {
